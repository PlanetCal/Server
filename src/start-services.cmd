...
REM start cmd.exe /k "xcopy /s %~dp0\common\*.* %~dp0\UserDetailsService\common\ /Y & cd %~dp0\UserDetailsService\Common & npm install & cd %~dp0\UserDetailsService & npm install & title UserDetailsService & node.exe app.js %env% | node_modules\.bin\bunyan"
